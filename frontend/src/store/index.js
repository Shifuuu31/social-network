  ...
  getters: {
    ...
    filterUsers: (state) => (searchquery) => {
      ...
      state.users.allusers.filter((user) => {
        ...
        if (user.nickname?.toLowerCase().includes(searchquery.toLowerCase()) || user.firstName?.toLowerCase().includes(searchquery.toLowerCase()) || user.lastName?.toLowerCase().includes(searchquery.toLowerCase()) || user.email?.toLowerCase().includes(searchquery.toLowerCase())) {
          arr.push(user);
        }
      });
      return arr;
