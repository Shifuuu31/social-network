<template>
  <header class="header">
    <!-- Home Icon -->
    <router-link to="/" class="icon-container" aria-label="Home">
    ...
    <div class="icons">
      <!-- Groups Icon -->
      <router-link to="/groups" class="icon-container" aria-label="Groups">
      ...
      <!-- Notification Icon -->
      <router-link to="/notifications" class="icon-container" aria-label="Notifications">
